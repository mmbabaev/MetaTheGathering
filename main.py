...
def main() -> None:
    ...
    app.add_handler(CallbackQueryHandler(admin.callback_admin_pick_arch, pattern=f"^{CB_ADMIN_PICK_ARCH}:"))
    app.add_handler(CallbackQueryHandler(admin.callback_admin_set_arch, pattern=f"^{CB_ADMIN_SET_ARCH}:"))
    app.add_handler(CallbackQueryHandler(admin.callback_admin_arch_more, pattern=f"^{CB_ADMIN_ARCH_MORE}:"))
    app.add_handler(CallbackQueryHandler(admin.callback_admin_custom_arch, pattern=f"^{CB_ADMIN_CUSTOM_ARCH}:"))
