...
- Финальная очистка состава после импорта AetherHub удаляет зарегистрированных в боте no-show
  ...
  заполнена колода. Пока хотя бы одна колода AetherHub-участника не указана, состав не сокращается —
  PR [#263](https://github.com/mmbabaev/MetaTheGathering/pull/263).
