...
- Колоды из ячейки из
  ...
  переданная публичная Google-таблица: названия, физические копии, ссылки, дата актуальности и
  пометки доступности синхронизируются при старте и не реже чем раз в 15 минут при использовании
  web-каталога. Draft PR
