...
- Колоды из ячейки из
  [#260](https://github.com/mmbabaev/MetaTheGathering/issues/260): web-каталог физических
  копий с эксклюзивной бронью на понедельник и входом через персональную кнопку команды
  `/cellar`, автоматической записью архетипа в турнир и адресными DM о бронях/отменах. В
  ...
  web-каталог не делает сетевой запрос при открытии. Draft PR
