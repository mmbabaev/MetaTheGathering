...
- Колоды из ячейки из
  ...
  команды `/cellar` позволяет выбрать понедельник, физическую копию, открыть её деклист,
  забронировать или отменить бронь. Каталог показывает по 10 колод, закрепляя сверху активную
