...
- Защита незавершённых турниров при создании следующего события: планировщик больше не
  закрывает активный турнир автоматически; создание нового пропускается до ручной проверки
  и закрытия предыдущего.
