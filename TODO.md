...
- Колоды из ячейки из
  ...
  Telegram-никами и физическими колодами. Ивану и Сергею тот же список доступен в `/cellar`;
  весь flow закрыт выключенным по умолчанию `cellarDecks`. Source of truth —
