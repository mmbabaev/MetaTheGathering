...
- Второй этап Endstep Pauper leaderboard из
  ...
  из последнего успешного снимка в БД; отдельный systemd worker атомарно обновляет его
  после deploy и затем ежедневно в 11:00 и 23:00 МСК. Telegram flow никогда не
  обращается к Endstep.
