...
- Выход участника из турнира через Telegram, web или действие администратора автоматически
  отменяет связанную активную бронь ячейки и сразу освобождает физическую колоду — PR
  [#264](https://github.com/mmbabaev/MetaTheGathering/pull/264).
