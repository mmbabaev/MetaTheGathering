...
- Метаписцы получают в карточке активного турнира действия добавления
  участников и закрытия. Остальные admin-действия им не открываются; Telegram ID
  инициатора ручного закрытия сохраняется в турнире — issue
  [#316](https://github.com/mmbabaev/MetaTheGathering/issues/316), PR
