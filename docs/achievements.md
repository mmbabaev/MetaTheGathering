...
**Статус: фаза 1 реализована** (движок, 8 ачивок, теневой режим, `/achievements` для владельца и
админов, CLI). Фазы 2–6 — план. Разделы ниже описывают и то, что уже работает, и то, что впереди;
