...
**Статус: фазы 1–2 реализованы** (движок, 8 ачивок, теневой режим, `/achievements` для владельца и
админов, CLI, бэкафилл истории). Фазы 3–6 — план. Разделы ниже описывают и то, что уже работает, и то, что впереди;
