...
| Поле | Тип | Описание |
|------|-----|----------|
| `name` | string | Уникальное имя клуба (`Goldfish`, `Edinorog`, `Pair of dice`, `Hobby Games - Калининград`) |
...
| `timezone` | string | Локальная таймзона клуба; если не задана, используется общая |
