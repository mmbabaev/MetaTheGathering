...
class DeckReminderService:
    ...
    def pending_recipients(self, tournament_id: int, stage: DeckReminderStage) -> list[DeckReminderRecipient]:
        ...
        rows = self.db.execute(
            ...
            .where(
                ...
                or_(
                    ...
                    models.Tournament.decklist_reminders_enabled.is_(False),
                ),
            )
