...
payload = {
    ...
    "params": {
        ...
        "igrok_4vy1": "Васильев Сергей",
        "uchastnik_0zyi": "Васильев Сергей",
    },
...
with open("datalens_vasiliev_response.json", "w", encoding="utf-8") as f:
    f.write(r.text)

print("Saved to datalens_vasiliev_response.json")
