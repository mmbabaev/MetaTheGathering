...
app_config = AppConfig(
    ...
    pair_of_dice_chat_id=-1003631429183,  # безопасный тестовый чат, не production Pair of dice
    hobby_games_chat_id=-1003631429183,  # безопасный тестовый чат, не production Hobby Games
