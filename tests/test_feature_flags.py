...
class TestFeatureFlagService:
    ...
    def test_internal_swiss_magicoculus_import_is_disabled_by_default(self, ff_svc):
        assert ff_svc.is_enabled(FeatureFlags.MAGIC_OCULUS_INTERNAL_SWISS_IMPORT) is False
